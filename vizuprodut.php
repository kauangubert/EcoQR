      ...
      <div>
        <table border="1" class="table">
            ...
            <tr>
                 ...
                 <td><a href="editarprodut.php?codigo=<?php echo $dado ["cod"]; ?>">Editar</a> |
                 <a href="javascript: if(confirm('Tem certeza que deseja excluir o Produto <?php echo $dado['nome']; ?> ?'))
                 location.href='excluirprod.php?codigo=<?php echo $dado['cod']; ?>'">Excluir</a></td>
            </tr>
            <?php } ?>
        </table>
      </div>
