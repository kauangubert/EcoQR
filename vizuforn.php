    ...
    <body>
        <table border="1">
            ...
            <tr>
                 ...
                 <td><a href="editarforn.php?codigo=<?php echo $dado ["cod"]; ?>">Editar</a> |
                 <a href="javascript: if(confirm('Tem certeza que deseja excluir o(a) Fornecedor(a) <?php echo $dado['nome']; ?> ?'))
                 location.href='excluirforn.php?codigo=<?php echo $dado['cod']; ?>'">Excluir</a></td>
            </tr>
            <?php } ?>
        </table>
    </body>
