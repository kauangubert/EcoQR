...
$sql = "INSERT INTO cliente (nome, cpf_cnpj, fone, email, responsavel, estado, cidade, bairro, rua, numero, cep, obs) VALUES('$nome', '$cpfcnpj', '$telefone', '$email', '$responsavel', '$estado', '$cidade', '$bairro', '$rua', '$numero', '$cep', '$obs')";
